 ...
 */
export function buildPrereqGraph(courseCode, buckets) {
    const nodes = [];
    const edges = [];
    ...
    const addGroup = (parentId, group, bucketType) => {
...
export function parsePrerequisites(text) {
    ...
    const buckets = { Pre: [], Concurrent: [], Cross: [], Classification: [] };
...
// --- Tree printer ---
export function printTree(courseName, buckets) {
